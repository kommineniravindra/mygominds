...
import { FaLaptopCode, FaProjectDiagram, FaUserTie, FaUserGraduate, FaUsers, FaChalkboardTeacher, FaBriefcase, FaCertificate, FaLaptop, FaHandshake, FaTrophy, FaUserFriends, FaHeadset } from 'react-icons/fa';
  ...
  return (
    <section className="learning-paths-section">
      <div className="learning-paths-header">
        <h2>Explore Our <span>Learning Paths</span></h2>
        <p>Choose from our most in-demand domains and build job-ready skills.</p>
      </div>
      ...
      <div className="learning-paths-container">
          ...
          <div className="lp-content-col">
            <div className="lp-content-top">
              <h3 className="lp-title">
                IT Training <span className="blue-text">Programs</span>
              </h3>
              ...
              <button className="lp-btn-primary blue-btn" onClick={() => window.location.href = '/services'}>
        ...
        <div className="lp-row-container lp-light-card">
          <div className="lp-content-col">
            <div className="lp-content-top">
              <h3 className="lp-title">
                Software Development <span className="orange-text">Programs</span>
              </h3>
              ...
              <button className="lp-btn-primary orange-btn" onClick={() => window.location.href = '/'}>
